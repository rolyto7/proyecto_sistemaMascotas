    ...
    <div id="body">
        ...
        <div class="sidebar">
            <div class="section">
                <div class="aside">
                    <ul>
                        <li><a href="<?= site_url('Welcome/AlimentoSecoPerros') ?>">Juguetes Gato</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Catnip Hierba Gatera</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Torres y Rascadores</a></li>
                </div>
            </div>
        </div>
    </div>
