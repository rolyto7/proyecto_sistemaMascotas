    ...
    <div id="body">
        ...
        <div class="sidebar">
            <div class="section">
                <div class="aside">
                    <ul>
                        <li><a href="<?= site_url('Welcome/Arenas_Sanitarias_Gatos') ?>">Arenas Sanitarias</a></li>
                        <li><a href="<?= site_url('Welcome/Areneros_Palas_Gatos') ?>">Areneros y Palas</a></li>
                        <li><a href="<?= site_url('Welcome/Limpieza_Hogar_Gatos') ?>">Limpieza de Hogar</a></li>
                        <li><a href="<?= site_url('Welcome/Shampoo_Aseo_Gatos') ?>">Shampoo y Aseo</a></li>
                        <li><a href="<?= site_url('Welcome/Peines_Cepillos_Gatos') ?>">Peines Cepillos</a></li>
                </div>
            </div>
        </div>
    </div>
