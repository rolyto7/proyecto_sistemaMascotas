    ...
    <div id="body">
        ...
        <div class="sidebar">
            <div class="section">
                <div class="aside">
                    <ul>
                        <li><a href="<?= site_url('Welcome/AlimentoSecoPerros') ?>">Arenas Sanitarias</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Areneros y Palas</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Cuidado de uñas</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Cuidado Dental</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Peines Cepillos y Cortadores</a>
                        </li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Shampoo y Aseo</a></li>
                </div>
            </div>
        </div>
    </div>
