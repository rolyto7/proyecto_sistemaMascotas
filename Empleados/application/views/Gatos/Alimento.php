    ...
    <div id="body">
        ...
        <div class="sidebar">
            <div class="section">
                <div class="aside">
                    <ul>
                        <li><a href="<?= site_url('Welcome/AlimentoGatos') ?>">Alimento Seco</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoGatos') ?>">Alimento Humedo</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoGatos') ?>">Snacks y Premios</a></li>
                </div>
            </div>
        </div>
    </div>
