...
<body>
    ...
    <div class="banner" style="background-image: url('<?= base_url() ?>assets/images/logoofertas.png');"></div>
    <div id="body">
        <div class="container">
            <div class="products">
                <?php if (!empty($productos)): ?>
                    <?php foreach ($productos as $row): ?>
                        ...
                        ?>
                        <?php if ($row->oferta > 0): // Mostrar solo productos con oferta ?>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <p class="card-text">
                                        <del>Bs. <?php echo number_format($row->precio, 2); ?></del> <br>
                                        <span>Bs. <?php echo number_format($precioConDescuento, 2); ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No se encontraron productos con oferta.</p>
                <?php endif; ?>
            </div>
        </div>
