...
<body>
    <div id="header">
        <a href="<?= site_url('Welcome/index') ?>" id="logo"><img src="<?= base_url() ?>assets/images/logo.gif" width="310" height="114" alt="Pet Shop Logo"></a>
        <ul class="navigation">
                ...
                <div class="product-info">
                    ...
                    <p class="product-price">
                        ...
                        <?php if ($producto['oferta'] > 0): ?>
                            ...
                            <span class="discount-price">Bs. <?= number_format($precioConDescuento, 2); ?> (<?= $descuento * 100; ?>% OFF)</span>
                        <?php else: ?>
                    ...
                    <div class="quantity-selector">
                        ...
                        <input type="number" id="cantidad" value="1" min="1" max="<?= $producto['stock']; ?>" class="form-control quantity-input">
                        <button type="button" class="btn btn-outline-secondary" onclick="this.parentNode.querySelector('input[type=number]').stepUp()">+</button>
                    </div>

                    <button type="button" class="add-to-cart" onclick="agregarAlCarrito(<?= $producto['producto_id']; ?>)">Añadir al carrito</button>
