    ...
    <div id="body">
        ...
        <div class="sidebar">
            <div class="section">
                <div class="aside">
                    <ul>
                        <li><a href="<?= site_url('Welcome/AlimentoSecoPerros') ?>">Juguetes de Goma </a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Pelotas y otros</a></li>
                        <li><a href="<?= site_url('Welcome/AlimentoHumedoPerros') ?>">Peluches</a></li>
                    </ul>
                </div>
            </div>
        </div>
