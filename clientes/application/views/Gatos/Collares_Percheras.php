            ...
            <div class="section">
                <div class="aside">
                    <ul>
                        ...
                        <li><a href="<?= site_url('Welcome/Platos_Dispensadores_Gatos') ?>">Platos y Dispensadores</a></li>
                        <li><a href="<?= site_url('Welcome/Transportadores_Jaulas_Gatos') ?>">Transportadores y Jaulas</a></li>
                        <li><a href="<?= site_url('Welcome/Collares_Percheras_Gatos') ?>">Collares Correas y Pecheras</a></li>
                    </ul>
                </div>
            </div>
        </div>
