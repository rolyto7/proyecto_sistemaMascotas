    ...
    <div id="body">
        ...
        <div class="sidebar">
            <div class="section">
                <div class="aside">
                    <ul>
                        <li><a href="<?= site_url('Welcome/Casas_Camas_Perros') ?>">Casas Camas y Frazadas</a></li>
                        <li><a href="<?= site_url('Welcome/Collares_Correas_Perros') ?>">Collares Correas y Pecheras</a></li>
                        <li><a href="<?= site_url('Welcome/Limpieza_Perros') ?>">Limpieza de Hogar</a></li>
                        <li><a href="<?= site_url('Welcome/Platos_Dispensadores_Perros') ?>">Platos y Dispensadores</a></li>
                        <li><a href="<?= site_url('Welcome/Ropa_Perros') ?>">Ropa</a></li>
                        <li><a href="<?= site_url('Welcome/Transportadores_Jaulas_Perros') ?>">Transportadores y Jaulas</a></li>
                    </ul>
                </div>
            </div>
        </div>
